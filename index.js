...
app.post('/api/products', auth, async (req, res) => {
    ...
    try {
        ...
        if (e.code === 'P2002') res.status(409).json({ error: `Produkt o nazwie "${name}" już istnieje.` });
...
// --- Pozostałe API (zaślepki) ---
// TODO: Uzupełnić resztę endpointów w miarę budowy frontendu
